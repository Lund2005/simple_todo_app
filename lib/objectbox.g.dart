  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 8200090634719517930),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 252454074048447950),
        name: 'identity',
        type: 9,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 2989203053398943402),
        name: 'name',
        type: 9,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(2, 6831039437372853359),
    lastIndexId: const obx_int.IdUid(0, 0),
    lastRelationId: const obx_int.IdUid(0, 0),
    lastSequenceId: const obx_int.IdUid(0, 0),
    retiredEntityUids: const [5159607849478085868],
...
class Task_ {
  ...
  /// See [Task.identity].
  static final identity = obx.QueryStringProperty<Task>(
    _entities[0].properties[1],
  );

  /// See [Task.name].
  static final name = obx.QueryStringProperty<Task>(_entities[0].properties[2]);
